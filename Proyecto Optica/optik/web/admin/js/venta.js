...
export function limpiarVentaProducto() {
    document.getElementById("txtClaveVenta").value = "";
    document.getElementById("txtTotalVenta").value = "";
    document.getElementById("tbodyVentaP").innerHTML = "";
    idAuto = 0; 
}
...
export function agregar(i) {
    ...
    contenido +=
            ...
            '<td><input id="txtDescuento' + idAuto + '" type="number" value = "0" onkeypress="return event.charCode >= 48 && event.charCode<=57"></td>' +
            '</tr>';
